...
class PostURLTests(TestCase):
    ...
    def test_post_urls_redirects_correct(self):
        """
        Проверка того, что анонимного пользователя перенаправляют на страницу логина.
        Авторизованного пользователя (не автора поста) перенаправляют на страницу с постом.
        """
